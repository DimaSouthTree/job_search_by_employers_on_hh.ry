...
class ApiGetService(ABC):
    employers = {"Первый Бит": '3177', "Яндекс": '1740', "Whoosh": '3536822', "ПАО Ростелеком": '2748',
                 "Лаборатория Касперского": '1057', "ПАО Газпром автоматизация": '903111', "Т1 Интеграция": '4872',
                 "IBS": '139', "АТОЛ, группа компаний": '3343', "Sitronics Group": '35065'}
...
class GetEmployer(ApiGetService):
    """
    Класс для подключения по АПИ к hh.ru. Реализованы два метода. Первый подключается к сайту и получает данные о работодателе по id. Воторой парсит полученные данные и записывает в массив.
    """
    ...
    def get_service_employer(self):
        """
        Отправляет Get запрос к сайту hh.ru с поиском работодателе по его id.
